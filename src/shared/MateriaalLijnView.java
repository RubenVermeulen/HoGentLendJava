 ...
 * @author Xander
 */
public class MateriaalLijnView {
    ...
    public MateriaalLijnView(Long id, LocalDateTime ophaalmoment, LocalDateTime indienmoment, MateriaalView materiaal, int aantal) {
        this.id = id;
